# Lô 39/43 — định vị vật thể theo mẫu tham chiếu
...
## Việc cần làm
Thư mục `images/` có 50 bài, đặt tên `batch_39_img001` … `batch_39_img050`. Mỗi bài gồm 4 file ảnh:
...
```
git add batch_39/RESULT.json
git commit -m "result: batch_39"
