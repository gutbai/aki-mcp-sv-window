# Lô 18/43 — định vị vật thể theo mẫu tham chiếu
...
## Việc cần làm
Thư mục `images/` có 50 bài, đặt tên `batch_18_img001` … `batch_18_img050`. Mỗi bài gồm 4 file ảnh:
...
```
git add batch_18/RESULT.json
git commit -m "result: batch_18"
