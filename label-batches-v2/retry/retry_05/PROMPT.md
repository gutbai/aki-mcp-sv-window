# Lô làm lại 5/5 — định vị vật thể theo mẫu tham chiếu
...
## Việc cần làm
Thư mục `images/` có 49 bài. Mỗi bài gồm 4 file ảnh:
...
```
git add retry_05/RESULT.json
git commit -m "result: retry_05"
