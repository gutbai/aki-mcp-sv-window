# Lô 14/43 — định vị vật thể theo mẫu tham chiếu
...
## Việc cần làm
Thư mục `images/` có 50 bài, đặt tên `batch_14_img001` … `batch_14_img050`. Mỗi bài gồm 4 file ảnh:
...
```
git add batch_14/RESULT.json
git commit -m "result: batch_14"
