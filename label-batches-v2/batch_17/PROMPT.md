# Lô 17/43 — định vị vật thể theo mẫu tham chiếu
...
## Việc cần làm
Thư mục `images/` có 50 bài, đặt tên `batch_17_img001` … `batch_17_img050`. Mỗi bài gồm 4 file ảnh:
...
```
git add batch_17/RESULT.json
git commit -m "result: batch_17"
