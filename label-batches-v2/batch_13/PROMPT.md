# Lô 13/43 — định vị vật thể theo mẫu tham chiếu

> **Cụm 2** — phiên này chỉ làm các lô 10–18, KHÔNG đụng lô ngoài khoảng đó.
> Nhiều phiên chạy song song, mỗi phiên một cụm; làm lấn cụm khác sẽ gây trùng việc và đụng file.

## Việc cần làm
Thư mục `images/` có 50 bài, đặt tên `batch_13_img001` … `batch_13_img050`. Mỗi bài gồm 4 file ảnh:
...
```
git add batch_13/RESULT.json
git commit -m "result: batch_13"
