# Lô 27/27 — định vị vật thể theo mẫu tham chiếu

## Việc cần làm
Thư mục `images/` có 20 bài, đặt tên `batch_27_img001` … `batch_27_img020`. Mỗi bài gồm 4 file ảnh:
...
- Làm hết 20 bài, không bỏ bài nào. Nếu một hình mẫu thật sự không tìm thấy trong cảnh, vẫn trả toạ độ của thứ giống nhất và ghi lý do vào `notes`.
